...
#define LENGTH_RAW_DATA 732
#define LENGTH_HEADER 7
#define RESOLUTION 0.5

const char header_data[] = {0x02, 0x80, 0xD6, 0x02, 0xB0, 0x69, 0x01};
...
const char ACK_baudrate[] = {0x06, 0x02, 0x80, 0x03, 0x00, 0xA0, 0x00, 0x10, 0x16, 0x0A};
